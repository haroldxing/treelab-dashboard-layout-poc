...
class MyFirstGrid extends React.Component {
  ...
  handleScroll = () => {
    //FIXME:  当drag 导致的不在可视区域的元素进入可视区域，但是同时没有触发滚动的时候，这时候iframe 没有放入新的src
  ...
  render() {
    const otherGridLayoutProps = {
      ...
      onResize: this.resizingHandle,
      // onResizeStop: () => {
      //   this.setState({ verticalCompact: false });
      // },
      ...
      onLayoutChange: (layout) => {
        this.setState({ isLayoutInit: true });
      },
    };

    console.log("final layout", this.state.layout);
